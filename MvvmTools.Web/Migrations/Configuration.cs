...
namespace MvvmTools.Web.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        public Configuration()
        {
            ...
            ContextKey = "MvvmTools.Web.Models.ApplicationDbContext";
        }
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            var oldAdminUser = userManager.Users.FirstOrDefault(u => u.UserName == Secrets.AdminEmail);
            if (oldAdminUser != null)
                userManager.Delete(oldAdminUser);
            ...
            var adminUser = userManager.Users.First(u => u.UserName == Secrets.AdminUserName).Id;

            context.MvvmTemplates.AddOrUpdate(
              t => new { t.ApplicationUserId, t.Name, t.Language },
              new MvvmTemplate { ApplicationUserId = adminUser, MvvmTemplateCategoryId = prismCategoryId, Name = "Prism w/ ViewModelLocator", Language = "C#",  Enabled = true, View = ".", ViewModel = ".", Tags = "." },
              new MvvmTemplate { ApplicationUserId = adminUser, MvvmTemplateCategoryId = caliburnMicroCategoryId, Name = "Caliburn.Micro Standard", Language = "C#", Enabled = true, View = ".", ViewModel = ".", Tags = "." },
              new MvvmTemplate { ApplicationUserId = adminUser, MvvmTemplateCategoryId = mvvmLightCategoryId, Name = "MVVM Light Standard", Language = "C#", Enabled = true, View = ".", ViewModel = ".", Tags = "." }
            );
