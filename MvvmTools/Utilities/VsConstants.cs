namespace MvvmTools.Utilities
{
    ...
    {
        // Project type guids
        internal const string WcfServiceProjectTypeGuid = "{E24C65DC-7377-472b-9ABA-BC803B73C61A}";
        internal const string SharedProjectProjectTypeGuid = "{D954291E-2A0B-460D-934E-DC6B0785DB48}";
