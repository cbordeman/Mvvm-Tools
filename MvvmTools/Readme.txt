...
1) To debug, you'll need to put this in MvvmTools | Project Properties | Debug
   ...
   Start External Program: C:\Program Files (x86)\Microsoft Visual Studio\2019\Preview\Common7\IDE\devenv.exe
   (might vary on your PC, and '14.0' will be greater if your VS is > VS2019)
